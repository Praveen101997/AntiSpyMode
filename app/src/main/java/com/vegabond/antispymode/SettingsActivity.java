...
public class SettingsActivity extends AppCompatActivity implements
    ...
    static  final void shareViaLink(){
        ...
        sharingIntent.putExtra(android.content.Intent.EXTRA_TEXT, "Anti Spy Mode App build by Praveen Kumar Sharma (Student of Delhi Technological University) : "+"https://praveensharma.cf/AntiSpyMode");
    ...
    static void helpPage(){
        String url = "https://praveensharma.cf/AntiSpyMode_Help";
